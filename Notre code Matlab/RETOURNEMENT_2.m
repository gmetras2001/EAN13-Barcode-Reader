...
figure; imagesc(I); axis image; colormap(gray); shading interp; colorbar;
title('Image de base');

%On effectue la rotation dans le bon sens 
if x1>x
Y=imrotate(I,-alpha,'crop');
figure; imagesc(Y); axis image; colormap(gray); shading interp; colorbar;
